...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/01/12 17:09:55 by dsoporan          #+#    #+#              #
#    Updated: 2017/01/12 17:54:21 by dsoporan         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_search_and_replace.c ft_how_many_digits.c ft_str_to_int.c ft_swap_bits.c \
ft_strrev.c 
